...
class CharEncoderLayer(nn.Module):
    def __init__(self, char_embed_dim, filters):
        super().__init__()
    ...
    # forward函数
    def forward(self, character_embedding):
        convs = []
...
class HighWay(nn.Module):
    def __init__(self, input_dim, num_layers):
        ...
        self._activation = F.relu(input_dim)
        # forward函数
