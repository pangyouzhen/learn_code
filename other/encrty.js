...
// 新增的
var window = this;
var location = "http://www.iwencai.com";
global.navigator={ userAgent: 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/89.0.4389.114 Safari/537.36', };
...
function encryptEncode(b, a, c) {
    if (!a || !c)
        throw Error("modulus and publicExponent could not be null");
    var d;
    d = new RSAKey;
    d.setPublic(a, c);
    b = d.encrypt(b);
...
// js main方法
//console.log(thsencrypt.encode("Steven2020"))
// js 打印变量类型
